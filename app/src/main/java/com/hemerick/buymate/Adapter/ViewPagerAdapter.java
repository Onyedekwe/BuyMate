...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        ImageView slideTitleImage = view.findViewById(R.id.onboardImage);
        TextView slideHeading = view.findViewById(R.id.onboardHeading);
        TextView slideSubHeading = view.findViewById(R.id.onboardsub_heading);
