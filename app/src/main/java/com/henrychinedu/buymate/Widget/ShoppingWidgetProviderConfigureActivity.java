...
import static com.henrychinedu.buymate.Widget.ShoppingWidgetProvider.ACTION_REFRESH;
import static com.henrychinedu.buymate.Widget.ShoppingWidgetProvider.ACTION_UPDATE_MY_WIDGET;
...
public class ShoppingWidgetProviderConfigureActivity extends Activity implements WidgetConfigAdapter.OnNoteListener {
    ...
    public void onNoteClick(int position) {
        ...
        if(currentYear < 2024 ||(currentYear == 2024 && currentMonth < 3) || (currentYear == 2024 && currentMonth == 3 && currentDay < 31) ){
            Toast.makeText(ShoppingWidgetProviderConfigureActivity.this, "Coming soon", Toast.LENGTH_SHORT).show();
        }else {
